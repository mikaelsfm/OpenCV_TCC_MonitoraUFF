/*
 * YOLOv8n + OpenCV CUDA + NVDEC (GTX 1050) - MODO HEADLESS FINAL
 *
 * Correção aplicada:
 * Na função dnn::blobFromImage, passamos a cv::Mat (CPU) 'h_frame_resized'
 * em vez da cv::cuda::GpuMat 'd_frame_resized'.
 */
...
int main(int argc, char** argv) {
    ...
    while (running) {
        ...
        // --- AQUI ESTAVA O ERRO E FOI CORRIGIDO ---
